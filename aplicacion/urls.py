...
from django.urls import path
from .views import index, carta, pedidos, pagar, carrito, tabla_pedidos, registro_usuario, login, admin, detalle, gestion_usuario, Carta_admin, agregar_al_carrito, eliminar_del_carrito,Agregar_Producto,admin_Carta_M,admin_Carta_E,Delivery_Guardar,Constraseña_Olvidada
from django.conf import settings
from django.conf.urls.static import static
urlpatterns = [
    ...
    path('olvide-mi-contraseña/',Constraseña_Olvidada,name='contraseña_olvidada'),
